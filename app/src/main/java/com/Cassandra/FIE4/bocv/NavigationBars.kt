...
fun TopNavBar (navController : NavController){
    ...
    TopAppBar(
        title = {
            Text(text = if (searchActive) "" else "TMDB")
        },
            ...
            if (searchActive){
                IconButton(
                    ...
                    Icon(
                        ...
                        contentDescription = "Croix pour fermer",
                ...
                IconButton(
                    ...
                    Icon(
                        ...
                        contentDescription = "Loupe pour la recherche",
                        modifier = Modifier.size(24.dp)
                    )
                }
            }
            ...
            Card(
                ...
                Row(
                    ...
                    IconButton(
                        ...
                        Icon(
                            painter = painterResource(id = R.drawable.cancel), // Icône de fermeture
